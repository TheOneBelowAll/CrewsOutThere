...
const apiPub = "5319aa21"
const apiSec = "24699527a63a4abe98e830b620b86f56"
...
func SendMessages() {
	...
	for {
		...
		statuscode = TestSend(messageJSON)
...
func TestSend(messageJSON []byte) int {
	...
	req, err := http.NewRequest("POST", "http://127.0.0.1:3001", bytes.NewBuffer(messageJSON))
	if err != nil {
	...
	req.SetBasicAuth(apiPub, apiSec)
