...
CREATE TABLE Queue (
    ...
    timestamp bigint NOT NULL,
    CONSTRAINT queue_pk PRIMARY KEY (message, timestamp)
);

CREATE TABLE Parents (
	parent_phone varchar(11),
    child_phone varchar(11),
    CONSTRAINT parents_pk PRIMARY KEY (parent_phone, child_phone)
);
...
INSERT INTO Members (phone_number, name, added_by, notify, is_valid, timestamp) VALUES ("14564564567", "Moe Kibley", "10987654321", 1, 1, 0);
INSERT INTO Members (phone_number, name, added_by, notify, is_valid, timestamp) VALUES ("12342342345", "Ape Kibley", "10987654321", 1, 1, 0);
INSERT INTO Members (phone_number, name, added_by, notify, is_valid, timestamp) VALUES ("11234567890", "Default User", "10987654321", 1, 1, 0);
INSERT INTO Members (phone_number, name, added_by, notify, is_Valid, timestamp) VALUES ("1", "cli", "1", 1, 1, 0);
